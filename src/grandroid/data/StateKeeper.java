...
public class StateKeeper {
    ...
    protected void load(View obj) {
        if (obj instanceof TextView) {
            ((TextView) obj).setText(settings.getString(obj.getTag().toString(), ""));
        } else if (obj instanceof EditText) {
            ((EditText) obj).setText(settings.getString(obj.getTag().toString(), ""));
        } else if (obj instanceof ListView) {
            ((ListView) obj).setSelectionFromTop(settings.getInt(obj.getTag().toString(), 0), 0);
        } else if (obj instanceof Gallery) {
            ((Gallery) obj).setSelection(settings.getInt(obj.getTag().toString(), 0));
        } else if (obj instanceof GridView) {
            ((GridView) obj).setSelection(settings.getInt(obj.getTag().toString(), 0));
        }
    }
}
