...
//        }
    ...
    public FrameLayout.LayoutParams layFrameFW(int gravity) {
        return new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT, gravity);
    }
    ...
    public FrameLayout.LayoutParams layFrameWF(int gravity) {
        return new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.FILL_PARENT, gravity);
    }
    ...
    public FrameLayout.LayoutParams layFrameFF() {
        return new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT, FrameLayout.LayoutParams.FILL_PARENT);
    }
    ...
    public FrameLayout.LayoutParams layFrameFF(int gravity) {
        return new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT, FrameLayout.LayoutParams.FILL_PARENT, gravity);
    }
    ...
    public LinearLayout addColLayout(boolean withScroll, ViewGroup.LayoutParams params) {
        ...
        if (withScroll) {
            ...
            sv.setScrollContainer(true);
            sv.setFocusable(true);
            sv.addView(ll, new ScrollView.LayoutParams(ScrollView.LayoutParams.FILL_PARENT, ScrollView.LayoutParams.WRAP_CONTENT));
            lastLayout.addView(sv, params);
        } else {
            lastLayout.addView(ll, params);
//            if (lastLayout instanceof LinearLayout && ((LinearLayout) lastLayout).getOrientation() == LinearLayout.HORIZONTAL) {
...
//            }
    ...
    public LayoutMaker insertSideMenu(View btnSlide, int resBtnNormal, int resBtnExpanded, int mode, int amount) {
        if (sideMenuController == null) {
            ...
            sideMenuLayout.addView(layout, new HorizontalScrollView.LayoutParams(HorizontalScrollView.LayoutParams.FILL_PARENT, HorizontalScrollView.LayoutParams.FILL_PARENT));
